...
QT_MOC_LITERAL(3, 25, 16), // "ClickableWidget*"
QT_MOC_LITERAL(4, 42, 13) // "currentWidget"

    },
    "ClickableWidget\0clicked\0\0ClickableWidget*\0"
    "currentWidget"
};
...
void ClickableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< ClickableWidget*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< ClickableWidget* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (ClickableWidget::*)(ClickableWidget * );
...
// SIGNAL 0
void ClickableWidget::clicked(ClickableWidget * _t1)
{
